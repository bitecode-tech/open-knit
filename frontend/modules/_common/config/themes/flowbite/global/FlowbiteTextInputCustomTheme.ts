...
export const FlowbiteTextInputCustomTheme: DeepPartial<TextInputTheme> = {
    field: {
        input: {
            base: "block w-full border focus:outline-none focus:ring-1 disabled:cursor-not-allowed disabled:opacity-50",
            colors: {
                gray: "border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:border-primary-300 focus:ring-primary-300",
                failure: "border-red-500 bg-white text-red-700 placeholder-red-700 focus:border-red-500 focus:ring-red-500"
            }
        }
    }
}
