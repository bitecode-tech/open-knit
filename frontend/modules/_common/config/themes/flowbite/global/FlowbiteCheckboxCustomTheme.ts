...
import {CheckboxTheme} from "flowbite-react";

export const FlowbiteCheckboxCustomTheme: DeepPartial<CheckboxTheme> = {
    base: "h-4 w-4 appearance-none rounded border border-gray-300 bg-gray-50 bg-[length:0.55em_0.55em] bg-center bg-no-repeat checked:border-transparent checked:bg-current checked:bg-check-icon focus:outline-none focus:ring-0 focus:ring-offset-0 focus:ring-transparent",
    color: {
